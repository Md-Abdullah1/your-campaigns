...
const registerUser = (dispatch, userData)=>{
    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$Slices$2f$AuthSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setLoading"])());
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/register", userData).then((response)=>{
        const { token, user } = response.data;
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$Slices$2f$AuthSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setAuthSuccess"])({
            token,
            user
        }));
    }).catch((err)=>{
...
const loginUser = (dispatch, credentials)=>{
    dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$Slices$2f$AuthSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setLoading"])());
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$apiClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/auth/login", credentials).then((response)=>{
        const { token, user } = response.data;
        dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$Slices$2f$AuthSlice$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setAuthSuccess"])({
            token,
            user
...
function RegisterPage() {
    ...
    const handleSubmit = (e)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$authService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["registerUser"])(dispatch, userData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__15f7ae86._.js.map