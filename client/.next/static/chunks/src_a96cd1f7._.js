...
"[project]/src/redux/Slices/LeadsSlice.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const leadSlice = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reduxjs$2f$toolkit$2f$dist$2f$redux$2d$toolkit$2e$modern$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createSlice"])({
    name: "leads",
    initialState,
    reducers: {
        setLoading: (state)=>{
...
"[project]/src/redux/store/hooks.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useAppSelector = (fn)=>{
    _s1();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$redux$2f$dist$2f$react$2d$redux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSelector"])(fn);
};
...
function Navbar() {
    ...
    const { user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$store$2f$hooks$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "Navbar.useAppSelector": (state)=>state.auth
    }["Navbar.useAppSelector"]);
    const [hideNavbar, setHideNavbar] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const handleLogout = ()=>{
        localStorage.removeItem("token");
...
_s(Navbar, "r/UwJ+ddnaS4UXEmyPcuAzYWKxc=", false, function() {
    return [
...
//# sourceMappingURL=src_a96cd1f7._.js.map